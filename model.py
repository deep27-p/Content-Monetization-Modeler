...
with st.form("prediction_form"):
    ...
    with col1:
        ...
        subscribers = st.number_input("👤 Subscribers", value=0, step=1)   # <-- Added field
    ...
    with col2:
        ...
        upload_date = st.date_input("📅 Upload Date")   # <-- Existing field
...
input_data = pd.DataFrame({
    ...
    "subscribers": [subscribers],    # <-- Added to dataframe
    "category": [category],
    "device": [device],
    "country": [country],
...
if submitted:
    ...
    prediction = max(0, prediction[0])   # avoid negative predictions
